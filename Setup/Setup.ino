...
void update_arduino(){
  ...
  //Download w/o validating cert to not have to manage fingerprints.
  client.setInsecure(); 
  ...
  t_httpUpdate_return ret = ESPhttpUpdate.update(client, UPDATE_BIN_URL);
   ...
   switch (ret) {
      case HTTP_UPDATE_FAILED: Serial.printf("HTTP_UPDATE_FAILED Error (%d): %s\n", ESPhttpUpdate.getLastError(), ESPhttpUpdate.getLastErrorString().c_str()); strip.setPixelColor(WEB_LED, RD_HEX_COLOR); break;

      case HTTP_UPDATE_NO_UPDATES: Serial.println("HTTP_UPDATE_NO_UPDATES"); break;

      case HTTP_UPDATE_OK: Serial.println("HTTP_UPDATE_OK"); strip.setPixelColor(WEB_LED, GN_HEX_COLOR); break;
    } 
...
//If Download and flash fails, do color loop
void loop() {
